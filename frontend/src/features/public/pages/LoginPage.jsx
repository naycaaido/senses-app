  ...
  return (
    <div className='flex min-h-screen flex-col bg-[#fbf8f3] md:flex-row'>
      <div className='flex flex-1 flex-col justify-between gap-6 bg-[#3d4940] p-6 md:p-12'>
        <div
          onClick={handleBack}
          className='flex items-baseline whitespace-nowrap font-serif leading-none cursor-pointer'
        >
          <span className='text-2xl font-bold tracking-[0.18em] text-[#fbf8f3]'>
            SENSE&rsquo;S
          </span>
        ...
        <div className='flex flex-1 flex-col justify-center'>
          ...
          <p className='mt-8 font-serif text-[22px] italic leading-[28.6px] text-[#a8945e]'>
            Healthy Skin. Live Well.
          </p>
        </div>
      ...
      <div className='flex flex-1 items-start justify-center px-6 py-8 md:items-center md:px-12 md:py-10'>
        <div className='w-full max-w-md'>
          <h2 className='m-0 font-serif text-[28px] font-bold leading-[35px] text-[#2c2c2c]'>
            Masuk ke akun Anda
          </h2>
          ...
          >
            ...
            <div className='mb-4'>
              ...
              <div className='relative'>
                <input
                  className='h-[46px] w-full rounded-xl border border-[#f0ede7] bg-white px-[15px] py-[11px] text-[15px] leading-6 text-[#2c2c2c] outline-none placeholder:text-[#6b6b6b] focus:border-[#3d4940]'
                  id='password'
          ...
          <Link
            to='/'
            className='mt-10 block text-center text-xs leading-4 tracking-[0.06em] text-[#6b6b6b] underline'
          >
