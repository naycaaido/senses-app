...
const initialServices = [
  {
    ...
    duration: 30,
    status: "Aktif",
    description: "Konsultasi awal bersama dokter spesialis kulit.",
  },
  {
    id: "SVC-02",
    ...
    duration: 60,
    status: "Aktif",
    description: "Paket perawatan awal untuk kulit berjerawat.",
  },
  {
    id: "SVC-03",
    ...
    duration: 60,
    status: "Aktif",
    description: "Facial dasar untuk membersihkan dan menyegarkan kulit.",
  },
  {
    id: "SVC-04",
    ...
    duration: 60,
    status: "Nonaktif",
    description: "Eksfoliasi kimia untuk meratakan tekstur kulit.",
  },
  {
    id: "SVC-05",
    ...
    duration: 90,
    status: "Nonaktif",
    description: "Peremajaan kulit dengan teknologi laser.",
  },
];
...
const initialReservations = [
  {
    id: "RSV-2026-001",
    patientId: "P-9077",
    patientName: "Annisa Rahmawati",
    doctor: "Dr. Sarah Wijaya",
    service: "Konsultasi Kulit",
    price: 150000,
    date: "2026-07-20",
    time: "10.00",
    endTime: "10.30",
    status: "Terkonfirmasi",
    complaint: "Muncul kemerahan di area pipi sejak 2 minggu terakhir.",
    pembatalan: null,
    pembayaran: null,
  },
  {
    ...
    endTime: "10.00",
    status: "Terkonfirmasi",
    complaint: "Pemeriksaan rutin bulanan.",
    pembatalan: null,
    pembayaran: null,
  },
  {
    ...
    endTime: "11.15",
    status: "Terkonfirmasi",
    complaint: "Jerawat meradang di dahi.",
    pembatalan: null,
    pembayaran: null,
  },
  {
    ...
    doctor: "Dr. Sarah Wijaya",
    service: "Essential Facial",
    price: 250000,
    date: "2026-07-21",
    time: "11.00",
    endTime: "11.45",
    status: "Baru",
    complaint: "Kulit kusam.",
    pembatalan: null,
    pembayaran: null,
  },
  {
    ...
    endTime: "14.00",
    status: "Hadir",
    complaint: "Bekas jerawat membandel.",
    pembatalan: null,
    pembayaran: null,
  },
  {
    ...
    endTime: "15.00",
    status: "Selesai",
    complaint: "Kontrol lanjutan.",
    pembatalan: null,
    pembayaran: {
      no_reservasi: "RSV-2026-006",
      tanggal_bayar: "2026-06-14T00:00:00.000Z",
...
const initialSchedule = TIME_SLOTS.reduce((acc, slot) => {
  acc[slot] = {
    active: !INACTIVE_SLOTS.includes(slot),
    booked: BOOKED_SLOTS.includes(slot),
  };
  return acc;
}, {});
  ...
  const value = useMemo(() => {
    ...
    return {
      ...
      completeReservation(id) {
        ...
        setReservations((prev) =>
          prev.map((r) =>
            r.id === id ? { ...r, status: "Selesai", pembayaran: null } : r,
          ),
        );
      },
      ...
      toggleSlot(slot) {
        setSchedule((prev) =>
          prev[slot].booked
            ...
            : {
                ...prev,
                [slot]: { ...prev[slot], active: !prev[slot].active },
              },
        );
      },
      setAllSlots(active) {
        setSchedule((prev) =>
          Object.fromEntries(
            Object.entries(prev).map(([slot, v]) => [
              slot,
              v.booked ? v : { ...v, active },
            ]),
          ),
...
export function bookedSlots(reservations, date) {
  return reservations
    .filter((r) => r.date === date && r.status !== "Dibatalkan")
    .map((r) => r.time);
}
