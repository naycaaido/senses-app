...
export default function PatientNoActiveReservationPreviewPage() {
  return (
    <div className='mx-auto max-w-[1200px] px-4 pb-8 pt-4 md:px-6 md:pb-12 md:pt-6'>
      ...
      <div className='flex flex-col items-stretch gap-6 min-[1025px]:items-start min-[1025px]:flex-row'>
        ...
        <section className='flex min-w-0 flex-1 flex-col gap-4'>
          <div className='rounded-2xl border border-[#f0ede7] bg-white p-5 md:p-[25px]'>
            <div className='flex flex-col items-start gap-5 sm:flex-row sm:items-center'>
              ...
              <div className='min-w-0 flex-1'>
                ...
                <p className='mt-1 text-[15px] leading-6 text-[#6b6b6b]'>
                  Pilih layanan terlebih dahulu, kemudian tentukan tanggal dan
                  jam yang tersedia.
                </p>
              </div>
            </div>
            ...
            <div className='mt-6 grid grid-cols-1 gap-3 border-y border-[#f0ede7] py-5 sm:grid-cols-3'>
              {[
                ...
                <div key={number} className='flex gap-3 px-1 sm:px-3'>
                  ...
                  <div>
                    <p className='m-0 text-sm font-semibold text-[#2c2c2c]'>
                      {title}
                    </p>
            ...
            <Link
              to='/pasien/layanan'
              className='mt-6 inline-flex items-center gap-2 rounded-full bg-[#3d4940] px-5 py-2.5 text-[15px] font-medium leading-6 text-[#fbf8f3] transition-colors hover:bg-[#0c3320]'
            >
              Buat Reservasi
              <img
          ...
          <Link
            to='/pasien/riwayat'
            className='flex items-center justify-between rounded-2xl border border-[#f0ede7] bg-white p-[21px] transition-colors hover:bg-[#faf7f2]'
          >
            <div>
